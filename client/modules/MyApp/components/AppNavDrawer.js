    ...
    return (
      <div
        ...
        onTouchTap={this
          .handleTouchTap
          .bind(this, '/')}>
        <img alt="index.jpg" width="100%" height="64px" src="/image/icons/index.jpg"/>
      </div>
    );
  }
      ...
      <Scrollbars universal={true} autoHide={true}>
        ...
        <SelectableList value={selectedIndex} onChange={onChangeList}>
          ...
          <ListItem
            ...
            nestedItems={(['攻略', '神龍願望', '裝備', '偷盜物品', '異界魂'].map((v, k) => (<ListItem key={k} value={k + 2} primaryText={v}/>)))}/>
          <Divider/>
          <ListItem
            primaryText="天空戰"
            value="#"
          ...
          <ListItem
            ...
            value="#"
            primaryTogglesNestedList={true}
            nestedItems={(['新手Q&A'].map((v, k) => (<ListItem key={k} value={k + 2} primaryText={v}/>)))}/>
          <Divider/>
          <ListItem
            value="/about"
            href="/about"
  ...
  render() {
    ...
    return (
      <Drawer
        ...
        containerStyle={this.props.browser.greaterThan.medium
          ? {
            top: 64,
