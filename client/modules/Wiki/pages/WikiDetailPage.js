...
import WikiDetailTabs, {WIKI_CONTENT_SLIDE, WIKI_HITSTORY_SLIDE} from '../components/WikiDetailTabs/WikiDetailTabs';
...
class WikiDetailPage extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (this.props.wikiId !== nextProps.wikiId || this.props.rootWikiId !== nextProps.rootWikiId) {
...
WikiDetailPage.need = [].concat((params) => {
  const {wikiId} = params;
  return wikiId
    ? fetchWiki(wikiId)
    : emptyThunkAction;
