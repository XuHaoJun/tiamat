  ...
  render() {
    return (
      <div style={this.props.style}>
        <Tabs style={this.props.tabsStyle} onChange={this.handleChange} value={this.state.slideIndex}>
        ...
        <EnhancedSwipeableViews
          scrollKey="hometabs"
          scrollBehaviorShouldUpdateScroll={this.props.scrollBehaviorShouldUpdateScroll}
