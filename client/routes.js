...
export default(
  <Route path="/" component={MyApp}>
    ...
    <Route
      ...
      getComponent={(nextState, cb) => {
        require.ensure([], (require) => {
          cb(null, require('./modules/Setting/pages/SettingDetailPage').default);
        });
      }}/>
    <Route
      path="/forumBoards/:forumBoardId/rootDiscussions/:parentDiscussionId"
      component={DiscussionDetailPage}/>
    <Route path="/forumBoards/:forumBoardId/rootDiscussions" component={MixedMainPage}/>
    <Route
    ...
    <Route
      ...
      getComponent={(nextState, cb) => {
        require.ensure([], (require) => {
          cb(null, require('./modules/RootWiki/pages/EditRootWikiGroupTreePage').default);
        });
      }}/>
    <Route
      ...
      getComponent={(nextState, cb) => {
        require.ensure([], (require) => {
          cb(null, require('./modules/Discussion/pages/CreateRootDiscussionPage').default);
        });
      }}/>
    <Route
      ...
      getComponent={(nextState, cb) => {
        require.ensure([], (require) => {
          cb(null, require('./modules/ForumBoard/pages/CreateForumBoardPage').default);
        });
      }}/>
    <Route
      ...
      getComponent={(nextState, cb) => {
        require.ensure([], (require) => {
          cb(null, require('./modules/RootWiki/pages/CreateRootWikiPage').default);
        });
      }}/>
    <Route
    ...
    <Route
      ...
      getComponent={(nextState, cb) => {
        require.ensure([], (require) => {
          cb(null, require('./modules/User/pages/UserOauth2CallbackPage').default);
        });
      }}/>
    <Route
      path="/search"
