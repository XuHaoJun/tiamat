...
if (process.env.NODE_ENV === 'production') {
  app.use(Express.static(path.resolve(__dirname, '../dist'), { maxAge: '10d' }));
}
app.use(Express.static(path.resolve(__dirname, '../assets'), { maxAge: '10d' }));
app.use(passport.initialize());

// closure handle hot reload route.
const _apiRoutes =
  process.env.NODE_ENV === 'production' ? apiRoutes : (...args) => apiRoutes.handle(...args);
...
if (module.hot) {
  module.hot.accept(['./apiRoutes', '../client/App', './renderClientRoute'], () => {
